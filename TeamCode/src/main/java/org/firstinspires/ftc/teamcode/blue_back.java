    ...
    private void runAutonomousSequence() {
        ...
        switch (autonomousSequenceStep) {
            ...
            case 2:
                ...
                middle.setPower(1);
                transfer.setPower(1);
                navigateToTargetWaypoint(new Waypoint(250.0, -1300, ODOMETRY_ANGLE_UNIT.fromDegrees(-90), false));
             sleep(900);
                intake.setPower(0);
                middle.setPower(1);
                transfer.setPower(0);
            ...
            case 4:
                ...
                middle.setPower(0);
                intake.setPower(0);
                navigateToTargetWaypoint(new Waypoint(500, -220.0, ODOMETRY_ANGLE_UNIT.fromDegrees(-90), true));
