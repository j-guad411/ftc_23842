...
@Autonomous(name = "blue_backpidf6")
//@Disabled
public class blue_pid6 extends LinearOpMode {
    ...
    private void runAutonomousSequence() {
        ...
        switch (autonomousSequenceStep) {
            ...
            case 4:
                ...
                middle.setPower(0);
                intake.setPower(0);
                navigateToTargetWaypoint(new Waypoint(400, 280.0, ODOMETRY_ANGLE_UNIT.fromDegrees(90), false));
