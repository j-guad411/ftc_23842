...
@Autonomous(name = "blue_backpidf3")
//@Disabled
public class blue_pid3 extends LinearOpMode {
    ...
    private void runAutonomousSequence() {
        ...
        switch (autonomousSequenceStep) {
            ...
            case 1:
                ...
                navigateToTargetWaypoint(new Waypoint(100, 700, ODOMETRY_ANGLE_UNIT.fromDegrees(90), false));
